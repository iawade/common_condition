...
mv ${LOGFILE} ${OUTPUT}/
mv logs ${OUTPUT}/${ANC}_${CHR}_logs_plink
mv final_saige_outputs ${OUTPUT}/${ANC}_${CHR}_final_saige_outputs_plink
mv final_run_files ${OUTPUT}/${ANC}_${CHR}_final_run_files_plink
mv brava_final_conditional_analysis_results.txt ${OUTPUT}/brava_${ANC}_${CHR}_final_conditional_analysis_results_plink.txt
mv brava_final_conditional_analysis_results.txt.singleAssoc.txt ${OUTPUT}/brava_${ANC}_${CHR}_final_conditional_analysis_results.txt.singleAssoc_plink.txt
